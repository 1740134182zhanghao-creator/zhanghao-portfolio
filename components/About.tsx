...
export function About() {
  return (
    <section id="about" className="mx-auto grid max-w-7xl items-center gap-10 px-6 py-32 md:grid-cols-[0.9fr_1.1fr]">
      <Reveal>
        <GlassCard className="relative aspect-square overflow-hidden rounded-[3rem] p-6">
          ...
          <div className="absolute bottom-8 left-8 right-8 rounded-[1.7rem] border border-white/70 bg-white/48 p-4 text-center text-sm text-slate-500 shadow-glass backdrop-blur-2xl">个人照片替换入口</div>
        </GlassCard>
      </Reveal>
      <div>
