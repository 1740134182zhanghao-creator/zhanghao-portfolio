...
export function Contact() {
  return (
    <MotionSection id="contact" className="mx-auto max-w-5xl px-6 py-36 text-center">
      <Reveal>
        <GlassCard className="shine rounded-[3.4rem] p-10 md:p-16">
          ...
          <div className="mt-11 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <a className="rounded-full border border-white/80 bg-white/28 px-8 py-4 font-medium text-slate-900 shadow-sm backdrop-blur-2xl transition hover:-translate-y-1 hover:bg-white/24 focus:outline-none focus:ring-2 focus:ring-slate-400" href="#">下载简历</a>
          </div>
        </GlassCard>
      </Reveal>
    </MotionSection>
