...
export function Skills() {
  return (
    <MotionSection id="skills" className="mx-auto max-w-7xl px-6 py-32">
            ...
            <GlassCard className="h-full rounded-[2.5rem] p-8">
              ...
              <div className="mt-7 flex flex-wrap gap-3">
                {group.items.map((item) => (
                  <span key={item} className="rounded-full border border-white/80 bg-white/26 px-4 py-2.5 text-sm leading-6 text-slate-700 shadow-sm backdrop-blur-xl">
